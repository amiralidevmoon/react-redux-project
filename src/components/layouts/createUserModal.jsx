...
function CreateUserModal() {
    return (
        <div id="authentication-modal" tabIndex="-1" aria-hidden="true"
             className="overflow-y-auto overflow-x-hidden fixed z-50 w-full h-modal md:h-full grid place-items-center">
                ...
                <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    ...
                    <div className="py-6 px-6 lg:px-8">
                        ...
                        <form className="space-y-6" action="#">
                            ...
                            <div>
                                <label htmlFor="password" className="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Your
                                    password</label>
