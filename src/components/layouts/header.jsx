...
const Header = () => {
    ...
    return (
        <nav className="bg-white border-gray-200 px-2 sm:px-4 py-2.5 rounded dark:bg-gray-800 top-10 relative grid place-items-center">
                        ...
                        <li>
                            <NavLink to="/" style={({isActive}) =>
                                isActive ? activeStyle : undefined
                                     ...
                                     className="block py-2 pr-4 pl-3 bg-blue-700 rounded md:bg-transparent md:text-blue-700 md:p-0 text-gray-700 dark:text-gray-400"
                            >
                                Home
                            </NavLink>
                        </li>
